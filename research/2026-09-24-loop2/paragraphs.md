...
## Pre-speech compliance gate for AI voice agents (from shaper 7)

Businesses in consumer lending, insurance and telemarketing are moving sales and service calls to AI voice agents. But the FCC treats an AI voice as an "artificial voice" under the TCPA, which carries $500 to $1,500 per violating call, and TCPA class actions hit a record in 2025, including suits over AI calls. We sell to teams that build voice agents for regulated clients on platforms such as Retell and Vapi. Our layer checks every sentence the agent is about to say against a versioned rulebook of federal and state rules and the client's own script. It blocks a violating sentence before the caller hears it and substitutes a pre-approved line. It also writes a per-call record of what was disclosed and blocked, ready for regulators or courts. Customers pay about $500 a month plus one to two cents per monitored minute.

## Plain-English scam rules, backtested (from shaper 8)

Online marketplaces lose users and money to scams that live in listing text and messages, and their trust-and-safety teams test new detection rules slowly, mostly with keyword lists. We sell to marketplace fraud and trust-and-safety teams a tool where an analyst writes a suspicion in plain English. Our AI turns it into a few yes/no questions and scores them on a sample of the team's own labelled past cases. It reports how many extra scams the rule would have caught, and how many good users it would have flagged, at the team's current review volume. The winning questions then ship as features into whatever rules engine the team already runs, with a record of the evidence behind every rule. Text can only raise a risk score, never clear an account. Customers pay $30,000 to $100,000 a year.

## Pre-release child-safety testing for chatbots (from shaper 1)

California's Adam's Law (SB 1119), signed in September 2026, requires companion chatbots that minors can use to complete a documented risk assessment before every new or substantially changed release. It also bans behaviours toward minors such as claiming to be human, romance and encouraging emotional reliance, with penalties of $5,000 to $15,000 per affected child plus private suits; most duties start in July 2027. We sell to consumer AI apps that keep teen users, such as tutors, teen wellness apps and character apps. We run thousands of simulated multi-turn conversations with personas aged 13 to 17 against a staging copy of the bot, grade every reply against each clause of the law, and have clinicians review a sample. We deliver the required risk assessment plus a regression suite that reruns on every model or prompt change. Pricing is $15,000 to $40,000 per assessment plus $2,000 to $5,000 a month.

## Reshoring leads for job shops (from shaper 4)

US job shops and contract manufacturers are quoting more work that could move back from overseas, but they lose most of it to imports on price, and they can't track which companies just saw import costs jump after the 2026 tariff changes. In a 2026 survey, 32% of contract manufacturers were quoting reshoring work, double the year before, yet only 45% were satisfied with how it was going. We sell to US contract manufacturers with 10 to 249 employees in machining, fabrication, plastics, castings and electronics assembly. Our AI turns a shop's equipment list, certifications and sample parts into a capability profile and reads US sea import records. Every week it lists importers bringing in parts the shop could make, with shipment evidence, the tariff now applied, an estimated landed-cost gap, buyer contacts and a drafted pitch. Shops pay $6,000 to $12,000 a year.
