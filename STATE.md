...
Updated September 18, 2026. This file owns current decisions; [METHOD.md](METHOD.md) owns the active process.
...
| Claims-file compliance grading for auto/GL TPAs (B3a) | Re-screen pending at the time of writing; see `CANDIDATES-JEV.md` | |
